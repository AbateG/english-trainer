...
const CURRICULUM = {
  ...
  A1: {
    skills: [
      ...
      {
        id:'a1-reading',
        title_es:'Lectura: Un día normal',
        title_en:'Reading: An ordinary day',
        desc_es:'Lee un texto corto y responde preguntas sencillas.',
        desc_en:'Read a short text and answer simple questions.',
        exercises: [
          { type:'mcq',
            passage_en:'My name is Ana. I am from Venezuela. I live with my mother, my father, and my brother. Every morning I wake up at seven o\'clock. I have breakfast and I go to school.',
            passage_es:'Mi nombre es Ana. Soy de Venezuela. Vivo con mi madre, mi padre y mi hermano. Cada mañana me levanto a las siete. Desayuno y voy a la escuela.',
            prompt_es:'¿Dónde es Ana de?', prompt_en:'Where is Ana from?',
            options:['Venezuela','Colombia','Spain','Mexico'], answer:'Venezuela' },
          { type:'mcq',
            passage_en:'My name is Ana. I am from Venezuela. I live with my mother, my father, and my brother. Every morning I wake up at seven o\'clock. I have breakfast and I go to school.',
            passage_es:'Mi nombre es Ana. Soy de Venezuela. Vivo con mi madre, mi padre y mi hermano. Cada mañana me levanto a las siete. Desayuno y voy a la escuela.',
            prompt_es:'¿A qué hora se levanta Ana?', prompt_en:'What time does Ana wake up?',
            options:['Seven o\'clock','Eight o\'clock','Six o\'clock','Nine o\'clock'], answer:'Seven o\'clock' },
          { type:'mcq',
            passage_en:'My name is Ana. I am from Venezuela. I live with my mother, my father, and my brother. Every morning I wake up at seven o\'clock. I have breakfast and I go to school.',
            passage_es:'Mi nombre es Ana. Soy de Venezuela. Vivo con mi madre, mi padre y mi hermano. Cada mañana me levanto a las siete. Desayuno y voy a la escuela.',
            prompt_es:'¿Con quién vive Ana?', prompt_en:'Who does Ana live with?',
            options:['Her mother, father, and brother','Her mother only','Her grandparents','Alone'], answer:'Her mother, father, and brother' },
        ]
      },
      {
        id:'a1-colors-objects',
        title_es:'Colores y objetos',
        title_en:'Colors & objects',
        desc_es:'Vocabulario básico de colores y objetos cotidianos.',
        desc_en:'Basic vocabulary for colors and everyday objects.',
        exercises: [
          { type:'mcq', prompt_es:'"Rojo" en inglés es:', prompt_en:'"Rojo" in English is:',
            options:['Red','Blue','Green','Yellow'], answer:'Red', speak:'The car is red.' },
          { type:'fill', prompt_es:'Completa: "The sky is ___." (azul)', prompt_en:'Complete: "The sky is ___."',
            answer:'blue', speak:'The sky is blue.' },
          { type:'mcq', prompt_es:'¿Cómo se dice "silla" en inglés?', prompt_en:'How do you say "silla" in English?',
            options:['Chair','Table','Door','Window'], answer:'Chair', speak:'This is a chair.' },
          { type:'fill', prompt_es:'Completa: "I write with a ___." (lápiz)', prompt_en:'Complete: "I write with a ___."',
            answer:'pencil', speak:'I write with a pencil.' },
        ]
      },
      {
        id:'a1-days-time',
        title_es:'Días y la hora',
        title_en:'Days & time',
        desc_es:'Los días de la semana y cómo decir la hora.',
        desc_en:'Days of the week and telling the time.',
        exercises: [
          { type:'mcq', prompt_es:'¿Cuál es el primer día de la semana en inglés (calendario US)?', prompt_en:'Which is the first day of the week in English (US calendar)?',
            options:['Sunday','Monday','Saturday','Friday'], answer:'Sunday', speak:'Sunday is the first day of the week.' },
          { type:'fill', prompt_es:'Completa: "Today is ___." (miércoles)', prompt_en:'Complete: "Today is ___."',
            answer:'Wednesday', speak:'Today is Wednesday.' },
          { type:'mcq', prompt_es:'¿Cómo preguntas la hora?', prompt_en:'How do you ask what time it is?',
            options:['What time is it?','What hour is it?','How much time?','What is the time now, tell?'],
            answer:'What time is it?', speak:'What time is it?' },
          { type:'fill', prompt_es:'Completa: "It is three o\'___." (en punto)', prompt_en:'Complete: "It is three o\'___."',
            answer:'clock', speak:"It is three o'clock." },
        ]
      },
    ]
  },
  ...
  A2: {
    skills: [
      ...
      {
        id:'a2-reading',
        title_es:'Lectura: Un fin de semana',
        title_en:'Reading: A weekend',
        desc_es:'Lee un texto corto en pasado y responde preguntas.',
        desc_en:'Read a short text in the past tense and answer questions.',
        exercises: [
          { type:'mcq',
            passage_en:'Last Saturday, Carlos went to the market with his sister. They bought fresh fruit and vegetables. Then they walked to a small restaurant and had lunch together. In the afternoon, they visited their grandmother.',
            passage_es:'El sábado pasado, Carlos fue al mercado con su hermana. Compraron frutas y verduras frescas. Luego caminaron a un restaurante pequeño y almorzaron juntos. Por la tarde, visitaron a su abuela.',
            prompt_es:'¿Con quién fue Carlos al mercado?', prompt_en:'Who did Carlos go to the market with?',
            options:['His sister','His mother','His friend','Alone'], answer:'His sister' },
          { type:'mcq',
            passage_en:'Last Saturday, Carlos went to the market with his sister. They bought fresh fruit and vegetables. Then they walked to a small restaurant and had lunch together. In the afternoon, they visited their grandmother.',
            passage_es:'El sábado pasado, Carlos fue al mercado con su hermana. Compraron frutas y verduras frescas. Luego caminaron a un restaurante pequeño y almorzaron juntos. Por la tarde, visitaron a su abuela.',
            prompt_es:'¿Qué hicieron después de comprar en el mercado?', prompt_en:'What did they do after shopping at the market?',
            options:['Had lunch at a restaurant','Went home immediately','Went to the beach','Watched a movie'], answer:'Had lunch at a restaurant' },
          { type:'mcq',
            passage_en:'Last Saturday, Carlos went to the market with his sister. They bought fresh fruit and vegetables. Then they walked to a small restaurant and had lunch together. In the afternoon, they visited their grandmother.',
            passage_es:'El sábado pasado, Carlos fue al mercado con su hermana. Compraron frutas y verduras frescas. Luego caminaron a un restaurante pequeño y almorzaron juntos. Por la tarde, visitaron a su abuela.',
            prompt_es:'¿A quién visitaron por la tarde?', prompt_en:'Who did they visit in the afternoon?',
            options:['Their grandmother','Their cousin','Their teacher','Their neighbor'], answer:'Their grandmother' },
        ]
      },
      {
        id:'a2-prepositions',
        ...
        desc_es:'Describir dónde están las cosas.',
        desc_en:'Describing where things are.',
        exercises: [
          { type:'mcq', prompt_es:'Traduce: "El libro está sobre la mesa."', prompt_en:'Translate: "El libro está sobre la mesa."',
            options:['The book is on the table.','The book is in the table.','The book is under the table.','The book is at the table.'],
            answer:'The book is on the table.', speak:'The book is on the table.' },
          { type:'fill', prompt_es:'Completa: "The cat is ___ the box." (dentro)', prompt_en:'Complete: "The cat is ___ the box."',
            answer:'in', speak:'The cat is in the box.' },
          { type:'mcq', prompt_es:'¿Cuál preposición significa "entre" (dos cosas)?', prompt_en:'Which preposition means "between" (two things)?',
            options:['between','among','under','behind'], answer:'between', speak:'The store is between the bank and the pharmacy.' },
          { type:'fill', prompt_es:'Completa: "The park is ___ my house." (cerca de)', prompt_en:'Complete: "The park is ___ my house."',
            answer:'near', speak:'The park is near my house.' },
        ]
      },
      {
        id:'a2-directions',
        title_es:'Pedir direcciones',
        title_en:'Asking for directions',
        desc_es:'Frases para pedir y entender direcciones.',
        desc_en:'Phrases for asking and understanding directions.',
        exercises: [
          { type:'mcq', prompt_es:'Traduce: "¿Cómo llego a la estación?"', prompt_en:'Translate: "¿Cómo llego a la estación?"',
            options:['How do I get to the station?','How I get to the station?','How arrive to the station?','Where is get the station?'],
            answer:'How do I get to the station?', speak:'How do I get to the station?' },
          { type:'fill', prompt_es:'Completa: "Turn ___ at the corner." (a la derecha)', prompt_en:'Complete: "Turn ___ at the corner."',
            answer:'right', speak:'Turn right at the corner.' },
          { type:'mcq', prompt_es:'¿Cuál frase indica seguir todo derecho?', prompt_en:'Which phrase means to keep going straight?',
            options:['Go straight ahead','Go right ahead','Go back ahead','Go around ahead'],
            answer:'Go straight ahead', speak:'Go straight ahead.' },
        ]
      },
    ]
  },
  B1: {
    skills: [
      ...
      {
        id:'b1-reading',
        title_es:'Lectura: Cambiando de carrera',
        title_en:'Reading: Changing careers',
        desc_es:'Lee un texto con presente perfecto y responde preguntas.',
        desc_en:'Read a text using present perfect and answer questions.',
        exercises: [
          { type:'mcq',
            passage_en:'Maria has worked as a nurse for ten years, but she has always wanted to study business. This year, she has finally decided to go back to school. She hasn\'t told her manager yet, but she plans to soon.',
            passage_es:'María ha trabajado como enfermera durante diez años, pero siempre ha querido estudiar negocios. Este año, finalmente ha decidido volver a estudiar. Todavía no se lo ha dicho a su jefe, pero planea hacerlo pronto.',
            prompt_es:'¿Cuánto tiempo ha trabajado María como enfermera?', prompt_en:'How long has Maria worked as a nurse?',
            options:['Ten years','Five years','Two years','Twenty years'], answer:'Ten years' },
          { type:'mcq',
            passage_en:'Maria has worked as a nurse for ten years, but she has always wanted to study business. This year, she has finally decided to go back to school. She hasn\'t told her manager yet, but she plans to soon.',
            passage_es:'María ha trabajado como enfermera durante diez años, pero siempre ha querido estudiar negocios. Este año, finalmente ha decidido volver a estudiar. Todavía no se lo ha dicho a su jefe, pero planea hacerlo pronto.',
            prompt_es:'¿Qué ha decidido hacer María este año?', prompt_en:'What has Maria decided to do this year?',
            options:['Go back to school to study business','Quit her job completely','Move to another country','Become a doctor'], answer:'Go back to school to study business' },
          { type:'mcq',
            passage_en:'Maria has worked as a nurse for ten years, but she has always wanted to study business. This year, she has finally decided to go back to school. She hasn\'t told her manager yet, but she plans to soon.',
            passage_es:'María ha trabajado como enfermera durante diez años, pero siempre ha querido estudiar negocios. Este año, finalmente ha decidido volver a estudiar. Todavía no se lo ha dicho a su jefe, pero planea hacerlo pronto.',
            prompt_es:'¿Le ha contado María a su jefe sobre su plan?', prompt_en:'Has Maria told her manager about her plan?',
            options:['Not yet','Yes, last week','Yes, this morning','She has no manager'], answer:'Not yet' },
        ]
      },
      {
        id:'b1-obligation',
        title_es:'Modales de obligación',
        title_en:'Modals of obligation',
        desc_es:'Expresar reglas, necesidad y consejo (must / have to / should).',
        desc_en:'Expressing rules, necessity, and advice (must / have to / should).',
        exercises: [
          { type:'mcq', prompt_es:'Traduce (regla externa): "Tienes que llevar tu pasaporte."', prompt_en:'Translate (external rule): "Tienes que llevar tu pasaporte."',
            options:['You have to bring your passport.','You must to bring your passport.','You should bring your passport.','You having to bring your passport.'],
            answer:'You have to bring your passport.', speak:'You have to bring your passport.' },
          { type:'fill', prompt_es:'Completa (consejo, no obligación): "You ___ see a doctor." (deberías)', prompt_en:'Complete (advice, not obligation): "You ___ see a doctor."',
            answer:'should', speak:'You should see a doctor.' },
          { type:'mcq', prompt_es:'¿Cuál oración expresa falta de necesidad?', prompt_en:'Which sentence expresses lack of necessity?',
            options:["You don't have to come if you're busy.","You mustn't come if you're busy.","You shouldn't come if you're busy.","You can't come if you're busy."],
            answer:"You don't have to come if you're busy.", speak:"You don't have to come if you're busy." },
          { type:'fill', prompt_es:'Completa (prohibición): "You ___ smoke in here." (no debes)', prompt_en:'Complete (prohibition): "You ___ smoke in here."',
            answer:"mustn't", speak:"You mustn't smoke in here." },
        ]
      },
      {
        id:'b1-first-second-conditional',
        title_es:'Primer y segundo condicional',
        title_en:'First & second conditionals',
        desc_es:'Hablar de posibilidades reales y situaciones hipotéticas.',
        desc_en:'Talking about real possibilities and hypothetical situations.',
        exercises: [
          { type:'mcq', prompt_es:'Traduce (posibilidad real): "Si llueve, me quedaré en casa."', prompt_en:'Translate (real possibility): "Si llueve, me quedaré en casa."',
            options:['If it rains, I will stay home.','If it rains, I would stay home.','If it rained, I will stay home.','If it rain, I stay home.'],
            answer:'If it rains, I will stay home.', speak:'If it rains, I will stay home.' },
          { type:'fill', prompt_es:'Completa (hipotético): "If I ___ rich, I would travel the world." (fuera)', prompt_en:'Complete (hypothetical): "If I ___ rich, I would travel the world."',
            answer:'were', speak:'If I were rich, I would travel the world.' },
          { type:'mcq', prompt_es:'¿Cuál oración es un segundo condicional correcto?', prompt_en:'Which sentence is a correct second conditional?',
            options:["If I had more time, I would learn Italian.","If I have more time, I would learn Italian.","If I had more time, I will learn Italian.","If I would have more time, I learn Italian."],
            answer:"If I had more time, I would learn Italian.", speak:"If I had more time, I would learn Italian." },
        ]
      },
    ]
  },
  B2: {
    skills: [
      ...
      {
        id:'b2-reading',
        title_es:'Lectura: Trabajo remoto',
        title_en:'Reading: Remote work',
        desc_es:'Lee un texto con voz pasiva y da tu opinión sobre las preguntas.',
        desc_en:'Read a text using passive voice and answer the questions.',
        exercises: [
          { type:'mcq',
            passage_en:'Remote work has been adopted by many companies since 2020. Employees are now given more flexibility, but some managers worry that productivity can\'t be measured as easily. Several studies have been conducted, and the results are still being debated.',
            passage_es:'El trabajo remoto ha sido adoptado por muchas empresas desde 2020. A los empleados ahora se les da más flexibilidad, pero algunos gerentes temen que la productividad no se pueda medir tan fácilmente. Se han realizado varios estudios, y los resultados todavía se están debatiendo.',
            prompt_es:'¿Desde cuándo se ha adoptado el trabajo remoto ampliamente?', prompt_en:'Since when has remote work been widely adopted?',
            options:['Since 2020','Since 2010','Since 2015','Since last month'], answer:'Since 2020' },
          { type:'mcq',
            passage_en:'Remote work has been adopted by many companies since 2020. Employees are now given more flexibility, but some managers worry that productivity can\'t be measured as easily. Several studies have been conducted, and the results are still being debated.',
            passage_es:'El trabajo remoto ha sido adoptado por muchas empresas desde 2020. A los empleados ahora se les da más flexibilidad, pero algunos gerentes temen que la productividad no se pueda medir tan fácilmente. Se han realizado varios estudios, y los resultados todavía se están debatiendo.',
            prompt_es:'¿Cuál es la preocupación principal de algunos gerentes?', prompt_en:"What is some managers' main concern?",
            options:["Productivity can't be measured as easily","Employees are unhappy","Salaries are too high","Offices are too expensive"], answer:"Productivity can't be measured as easily" },
          { type:'mcq',
            passage_en:'Remote work has been adopted by many companies since 2020. Employees are now given more flexibility, but some managers worry that productivity can\'t be measured as easily. Several studies have been conducted, and the results are still being debated.',
            passage_es:'El trabajo remoto ha sido adoptado por muchas empresas desde 2020. A los empleados ahora se les da más flexibilidad, pero algunos gerentes temen que la productividad no se pueda medir tan fácilmente. Se han realizado varios estudios, y los resultados todavía se están debatiendo.',
            prompt_es:'¿Están los resultados de los estudios completamente resueltos?', prompt_en:'Are the study results fully settled?',
            options:['No, they are still being debated','Yes, completely','No studies were conducted','Yes, immediately after 2020'], answer:'No, they are still being debated' },
        ]
      },
      {
        id:'b2-relative-clauses',
        title_es:'Cláusulas relativas',
        title_en:'Relative clauses',
        desc_es:'Añadir información con who, which, that, whose.',
        desc_en:'Adding information with who, which, that, whose.',
        exercises: [
          { type:'mcq', prompt_es:'¿Cuál oración usa correctamente "who"?', prompt_en:'Which sentence correctly uses "who"?',
            options:['The man who called is my uncle.','The man which called is my uncle.','The man whom called is my uncle.','The man whose called is my uncle.'],
            answer:'The man who called is my uncle.', speak:'The man who called is my uncle.' },
          { type:'fill', prompt_es:'Completa (posesivo): "That\'s the woman ___ car was stolen." (cuyo)', prompt_en:'Complete (possessive): "That\'s the woman ___ car was stolen."',
            answer:'whose', speak:"That's the woman whose car was stolen." },
          { type:'mcq', prompt_es:'¿Cuál oración usa correctamente una cláusula relativa no esencial (con comas)?', prompt_en:'Which sentence correctly uses a non-essential relative clause (with commas)?',
            options:['My brother, who lives in Miami, is visiting us.','My brother who lives in Miami is visiting us, correctly.','My brother which lives in Miami, is visiting us.','My brother, whose lives in Miami, is visiting us.'],
            answer:'My brother, who lives in Miami, is visiting us.', speak:'My brother, who lives in Miami, is visiting us.' },
        ]
      },
      {
        id:'b2-used-to-would',
        title_es:'"Used to" y "would" para hábitos pasados',
        title_en:'"Used to" & "would" for past habits',
        desc_es:'Hablar de hábitos y estados que ya no existen.',
        desc_en:'Talking about habits and states that no longer exist.',
        exercises: [
          { type:'mcq', prompt_es:'Traduce (hábito pasado): "Solía jugar fútbol todos los días."', prompt_en:'Translate (past habit): "Solía jugar fútbol todos los días."',
            options:['I used to play soccer every day.','I use to play soccer every day.','I would to play soccer every day.','I was playing soccer every day, used.'],
            answer:'I used to play soccer every day.', speak:'I used to play soccer every day.' },
          { type:'fill', prompt_es:'Completa (estado pasado, no se usa "would"): "I ___ to live in a small town." (solía)', prompt_en:'Complete (past state, "would" not used for states): "I ___ to live in a small town."',
            answer:'used', speak:'I used to live in a small town.' },
          { type:'mcq', prompt_es:'¿Cuál oración usa "would" correctamente para un hábito repetido pasado?', prompt_en:'Which sentence correctly uses "would" for a repeated past habit?',
            options:['Every summer, we would visit our grandparents.','Every summer, we would have a house.','Every summer, we would be happy.','Every summer, we would know them.'],
            answer:'Every summer, we would visit our grandparents.', speak:'Every summer, we would visit our grandparents.' },
        ]
      },
    ]
  },
  ...
  C1: {
    skills: [
      ...
      {
        id:'c1-reading',
        title_es:'Lectura: El dilema del crecimiento',
        title_en:'Reading: The growth dilemma',
        desc_es:'Lee un texto argumentativo con conectores avanzados.',
        desc_en:'Read an argumentative text with advanced connectors.',
        exercises: [
          { type:'mcq',
            passage_en:'Many small businesses face a difficult choice when they start growing quickly. On one hand, hiring more staff can improve service; on the other, it increases costs significantly. Consequently, some owners choose to grow slowly, whereas others take the risk and expand immediately, hoping the investment will pay off.',
            passage_es:'Muchas pequeñas empresas enfrentan una decisión difícil cuando empiezan a crecer rápidamente. Por un lado, contratar más personal puede mejorar el servicio; por otro, aumenta los costos significativamente. En consecuencia, algunos dueños eligen crecer despacio, mientras que otros toman el riesgo y se expanden de inmediato, esperando que la inversión valga la pena.',
            prompt_es:'Según el texto, ¿qué pasa si una empresa contrata más personal?', prompt_en:'According to the text, what happens if a business hires more staff?',
            options:['Service can improve, but costs increase','Costs always decrease','Nothing changes','Customers leave immediately'], answer:'Service can improve, but costs increase' },
          { type:'mcq',
            passage_en:'Many small businesses face a difficult choice when they start growing quickly. On one hand, hiring more staff can improve service; on the other, it increases costs significantly. Consequently, some owners choose to grow slowly, whereas others take the risk and expand immediately, hoping the investment will pay off.',
            passage_es:'Muchas pequeñas empresas enfrentan una decisión difícil cuando empiezan a crecer rápidamente. Por un lado, contratar más personal puede mejorar el servicio; por otro, aumenta los costos significativamente. En consecuencia, algunos dueños eligen crecer despacio, mientras que otros toman el riesgo y se expanden de inmediato, esperando que la inversión valga la pena.',
            prompt_es:'¿Qué palabra del texto introduce un contraste entre dos decisiones?', prompt_en:'Which word in the text introduces a contrast between two decisions?',
            options:['whereas','consequently','significantly','immediately'], answer:'whereas' },
          { type:'mcq',
            passage_en:'Many small businesses face a difficult choice when they start growing quickly. On one hand, hiring more staff can improve service; on the other, it increases costs significantly. Consequently, some owners choose to grow slowly, whereas others take the risk and expand immediately, hoping the investment will pay off.',
            passage_es:'Muchas pequeñas empresas enfrentan una decisión difícil cuando empiezan a crecer rápidamente. Por un lado, contratar más personal puede mejorar el servicio; por otro, aumenta los costos significativamente. En consecuencia, algunos dueños eligen crecer despacio, mientras que otros toman el riesgo y se expanden de inmediato, esperando que la inversión valga la pena.',
            prompt_es:'¿Por qué algunos dueños se expanden de inmediato, según el texto?', prompt_en:'Why do some owners expand immediately, according to the text?',
            options:['They hope the investment will pay off','They have no other choice','The government requires it','Their staff insists on it'], answer:'They hope the investment will pay off' },
        ]
      },
      {
        id:'c1-causative',
        title_es:'Causativo (have/get something done)',
        title_en:'Causative (have/get something done)',
        desc_es:'Hablar de servicios que otra persona hace por ti.',
        desc_en:'Talking about services someone else does for you.',
        exercises: [
          { type:'mcq', prompt_es:'Traduce: "Me corté el cabello ayer." (alguien más lo hizo)', prompt_en:'Translate: "I had my hair cut yesterday." (someone else did it)',
            options:['I had my hair cut yesterday.','I cut my hair yesterday.','I have cutting my hair yesterday.','I was cut my hair yesterday.'],
            answer:'I had my hair cut yesterday.', speak:'I had my hair cut yesterday.' },
          { type:'fill', prompt_es:'Completa: "We are going to ___ the house painted next month." (hacer)', prompt_en:'Complete: "We are going to ___ the house painted next month."',
            answer:'have', speak:'We are going to have the house painted next month.' },
          { type:'mcq', prompt_es:'¿Cuál oración usa correctamente la estructura causativa?', prompt_en:'Which sentence correctly uses the causative structure?',
            options:['She got her car repaired.','She got repaired her car.','She got her car repair.','She has got her car to repair.'],
            answer:'She got her car repaired.', speak:'She got her car repaired.' },
        ]
      },
      {
        id:'c1-nominalization',
        title_es:'Nominalización y registro formal',
        title_en:'Nominalization & formal register',
        desc_es:'Convertir verbos en sustantivos para un tono más formal.',
        desc_en:'Turning verbs into nouns for a more formal tone.',
        exercises: [
          { type:'mcq', prompt_es:'¿Cuál es la forma nominalizada (más formal) de "The company decided to expand"?', prompt_en:'Which is the nominalized (more formal) form of "The company decided to expand"?',
            options:["The company's decision to expand...","The company decision to expand...","The deciding of the company to expand...","The company decides expansion..."],
            answer:"The company's decision to expand...", speak:"The company's decision to expand." },
          { type:'fill', prompt_es:'Completa (nominalización de "analyze"): "The ___ of the data took several weeks." (análisis)', prompt_en:'Complete (nominalization of "analyze"): "The ___ of the data took several weeks."',
            answer:'analysis', speak:'The analysis of the data took several weeks.' },
          { type:'mcq', prompt_es:'¿Cuál oración suena más formal/académica?', prompt_en:'Which sentence sounds more formal/academic?',
            options:['The implementation of the policy caused delays.','Doing the policy caused delays.','They did the policy and it caused delays.','Implementing it caused delays, they did.'],
            answer:'The implementation of the policy caused delays.', speak:'The implementation of the policy caused delays.' },
        ]
      },
    ]
  },
  ...
  C2: {
    skills: [
      ...
      {
        id:'c2-reading',
        title_es:'Lectura: Un ensayo sutil',
        title_en:'Reading: A nuanced essay',
        desc_es:'Lee un extracto académico con matices y responde con precisión.',
        desc_en:'Read an academic excerpt with hedged claims and answer precisely.',
        exercises: [
          { type:'mcq',
            passage_en:'It could be argued that remote work has fundamentally altered our understanding of productivity. Arguably, traditional metrics — hours logged, physical presence — are no longer sufficient. Nevertheless, it would be premature to conclude that all industries will be affected equally; some, by their very nature, still depend on in-person collaboration.',
            passage_es:'Se podría argumentar que el trabajo remoto ha alterado fundamentalmente nuestra comprensión de la productividad. Podría decirse que las métricas tradicionales —horas registradas, presencia física— ya no son suficientes. Sin embargo, sería prematuro concluir que todas las industrias se verán afectadas por igual; algunas, por su propia naturaleza, aún dependen de la colaboración presencial.',
            prompt_es:'¿Cuál es la postura del autor sobre las métricas tradicionales de productividad?', prompt_en:"What is the author's stance on traditional productivity metrics?",
            options:['They may no longer be sufficient','They are completely useless now','They are more accurate than ever','They were never useful'], answer:'They may no longer be sufficient' },
          { type:'mcq',
            passage_en:'It could be argued that remote work has fundamentally altered our understanding of productivity. Arguably, traditional metrics — hours logged, physical presence — are no longer sufficient. Nevertheless, it would be premature to conclude that all industries will be affected equally; some, by their very nature, still depend on in-person collaboration.',
            passage_es:'Se podría argumentar que el trabajo remoto ha alterado fundamentalmente nuestra comprensión de la productividad. Podría decirse que las métricas tradicionales —horas registradas, presencia física— ya no son suficientes. Sin embargo, sería prematuro concluir que todas las industrias se verán afectadas por igual; algunas, por su propia naturaleza, aún dependen de la colaboración presencial.',
            prompt_es:'¿Qué palabra señala que el autor está matizando, no afirmando con certeza absoluta?', prompt_en:'Which word signals the author is hedging, not stating absolute certainty?',
            options:['Arguably','Fundamentally','Nature','Industries'], answer:'Arguably' },
          { type:'mcq',
            passage_en:'It could be argued that remote work has fundamentally altered our understanding of productivity. Arguably, traditional metrics — hours logged, physical presence — are no longer sufficient. Nevertheless, it would be premature to conclude that all industries will be affected equally; some, by their very nature, still depend on in-person collaboration.',
            passage_es:'Se podría argumentar que el trabajo remoto ha alterado fundamentalmente nuestra comprensión de la productividad. Podría decirse que las métricas tradicionales —horas registradas, presencia física— ya no son suficientes. Sin embargo, sería prematuro concluir que todas las industrias se verán afectadas por igual; algunas, por su propia naturaleza, aún dependen de la colaboración presencial.',
            prompt_es:'Según el texto, ¿afecta el trabajo remoto a todas las industrias por igual?', prompt_en:'According to the text, does remote work affect all industries equally?',
            options:['No, some still depend on in-person collaboration','Yes, completely equally','No industries are affected','Only technology companies are affected'], answer:'No, some still depend on in-person collaboration' },
        ]
      },
      {
        id:'c2-cleft-sentences',
        title_es:'Oraciones hendidas (cleft sentences)',
        title_en:'Cleft sentences',
        desc_es:'Reestructurar oraciones para enfatizar una parte específica.',
        desc_en:'Restructuring sentences to emphasize one specific part.',
        exercises: [
          { type:'mcq', prompt_es:'¿Cuál es la versión enfática (cleft) de "Maria broke the vase"?', prompt_en:'Which is the emphatic (cleft) version of "Maria broke the vase"?',
            options:['It was Maria who broke the vase.','It was Maria broke the vase.','Maria was who broke the vase.','It Maria who broke the vase.'],
            answer:'It was Maria who broke the vase.', speak:'It was Maria who broke the vase.' },
          { type:'fill', prompt_es:'Completa (cleft con "what"): "___ I need is a good night\'s sleep." (lo que)', prompt_en:'Complete (cleft with "what"): "___ I need is a good night\'s sleep."',
            answer:'What', speak:"What I need is a good night's sleep." },
          { type:'mcq', prompt_es:'¿Cuál oración enfatiza correctamente el lugar?', prompt_en:'Which sentence correctly emphasizes the place?',
            options:["It was in Paris that they first met.","It was in Paris where they first met.","It Paris was that they first met.","There in Paris that they first met."],
            answer:"It was in Paris that they first met.", speak:"It was in Paris that they first met." },
        ]
      },
      {
        id:'c2-hypothetical-distance',
        title_es:'Distancia hipotética sutil',
        title_en:'Subtle hypothetical distance',
        desc_es:'Usar formas verbales para suavizar peticiones y opiniones.',
        desc_en:'Using verb forms to soften requests and opinions.',
        exercises: [
          { type:'mcq', prompt_es:'¿Cuál petición es más cortés/distante que "Can you help me"?', prompt_en:'Which request is more polite/distant than "Can you help me"?',
            options:['I was wondering if you could help me.','I want you help me.','You must help me now.','Help me, can you?'],
            answer:'I was wondering if you could help me.', speak:'I was wondering if you could help me.' },
          { type:'fill', prompt_es:'Completa (opinión suavizada): "It ___ appear that the plan has some flaws." (podría)', prompt_en:'Complete (softened opinion): "It ___ appear that the plan has some flaws."',
            answer:'would', speak:'It would appear that the plan has some flaws.' },
          { type:'mcq', prompt_es:'¿Cuál oración suaviza más una sugerencia?', prompt_en:'Which sentence most softens a suggestion?',
            options:["It might be worth considering an alternative approach.","Do an alternative approach.","You should do it differently.","Change it now."],
            answer:"It might be worth considering an alternative approach.", speak:"It might be worth considering an alternative approach." },
        ]
      },
    ]
  },
